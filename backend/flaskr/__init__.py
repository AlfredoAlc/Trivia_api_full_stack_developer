...
def create_app(test_config=None):
    ...
    def add_question():
        ...
        try:
            if search_term:
                ...
                question = paginate_questions(request, search_result)
    ...
    def start_playing():
        ...
        while check_if_used(random_question):
            random_question = questions[random.randrange(
                0, total_questions, 1)]
            if (len(previous_question) == total_questions):
                return jsonify({
                    'success': True
                })
...
# pagination at the bottom of the screen for three pages. Clicking on
# the page numbers should update the questions.
...
# TEST: When you submit a question on the "Add" tab, the form will
# clear and the question will appear at the end of the last page of
# the questions list in the "List" tab.
